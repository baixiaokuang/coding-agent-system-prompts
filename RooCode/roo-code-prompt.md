...
- args: Contains one or more file elements, where each file contains:
  - path: (required) File path (relative to workspace directory C:\Users\Unboundwill\Desktop)
...
- path: (required) The path of the directory to search in (relative to the current workspace directory C:\Users\Unboundwill\Desktop). This directory will be recursively searched.
...
- path: (required) The path of the directory to list contents for (relative to the current workspace directory C:\Users\Unboundwill\Desktop)
...
- path: (required) The path of the file or directory (relative to the current working directory C:\Users\Unboundwill\Desktop) to analyze. When given a directory, it lists definitions from all top-level source files.
  Usage:
  <list_code_definition_names>
  <path>Directory path here</path>
  </list_code_definition_names>
...
- The project base directory is: C:/Users/Unboundwill/Desktop
- All file paths must be relative to this directory. However, commands may change directories in terminals, so respect working directory specified by the response to <execute_command>.
- You cannot `cd` into a different directory to complete a task. You are stuck operating from 'C:/Users/Unboundwill/Desktop', so be sure to pass in the correct 'path' parameter when using tools that require a path.
...
Home Directory: C:/Users/Unboundwill
Current Workspace Directory: C:/Users/Unboundwill/Desktop
